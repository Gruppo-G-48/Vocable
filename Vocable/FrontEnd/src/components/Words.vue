...
export const words = [
  ...
  { word: "mano", definition: "Il segmento terminale degli arti superiori, deputato a funzioni di organo prensile e tattile: le dita, la palma, il dorso della m.; m. lunghe, sottili, ben curate" },
  ...
  { word: "patata", definition: "Pianta erbacea delle Solanacee ( Solanum tuberosum ), originaria dell'America, con stoloni sotterranei recanti diversi tuberi, detti anch'essi patate, fusto epigeo, foglie pelose, fiori bianchi, rosa o porpora, in cime terminali." },
  ...
  { word: "insetto", definition: "Nella classificazione zoologica, classe di artropodi che comprende il maggior numero di esseri viventi e i più varî per forma; hanno il corpo rivestito da una cuticola (dermascheletro o esoscheletro), sempre diviso in tre regioni: capo, torace e addome." },
  ...
  { word: "blu", definition: "Il colore stesso; è uno dei tre colori primari, insieme al verde e al rosso." },
  { word: "bolla", definition: "Piccola cavità sferoidale, piena di vapore o di gas, che si forma alla superficie o all'interno di un liquido in seguito a ebollizione, a variazioni di pressione o ad altri processi fisici o chimici." },
  { word: "pecora", definition: "Ruminante dei Bovidi ( Ovis aries ), intensamente allevato per la lana, la carne e il latte che fornisce; alto da 70 cm a più di 1 m, ha tronco tozzo, testa grande, muso stretto e camuso, orecchie di modeste dimensioni, corna presenti nel maschio, talvolta anche nelle femmine." },
  ...
  { word: "polpo", definition: "Nome com. dei Molluschi Cefalopodi degli Octopodi, part. dell’ Octopus vulgaris, con mantello muscoloso e a forma rotonda, diffuso nel Mediterraneo lungo la scogliera." },
  ...
  { word: "renna", definition: "Mammifero dei Cervidi ( Rangifer tarandus ), noto anche col nome di caribù, vivente in mandrie nelle tundre asiatico-europee e intensamente allevato sia come animale da tiro, sia per lo sfruttamento della sua carne, del latte e della pelliccia; è l'unico cervide che presenta le corna, spesso asimmetriche e variamente ramificate in entrambi i sessi. " },
  { word: "gentile", definition: "Aggettivo per descrivere una persona cortese, garbata, affabile." },
  { word: "vuoto", definition: "Privo di contenuto (contrapposto a pieno )" }
]
  ;
